            ...
            for(pageIdx=0; pageIdx<metadata.pages.length; pageIdx++) {
                ...
                if(pageConfig!==null) //We landed to right page now
                {
                    ...
                    while(i<loopCount) {
                        ...
                        repeatsourceDataValue = repeatsourceDataValue.match(/^[A-Za-z ]{3,}([-]){1,}[A-Za-z ]{3,}$/gm);
                        if(repeatsourceDataValue && repeatsourceDataValue.length>0)
                            ...
                            repeatsourceDataValue = repeatsourceDataValue.match(/\b[A-Za-z]{3}([-]){1,}[A-Za-z]{3}\b/gm);
                            if(repeatsourceDataValue && repeatsourceDataValue.length>0) {
                                repeatsourceDataValue = repeatsourceDataValue[0].replace('(', '').replace(')', '');
                            }
                        }
                        let src_dest = repeatsourceDataValue ? repeatsourceDataValue.replace('(', '').replace(')', '') : '';
