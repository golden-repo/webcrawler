    ...
    try
    {
        ...
        for (let index = 0; index < src_dest.length; index++) {
            ...
            switch (index) {
                ...
                case 12:
                    //this is rate
                    rate = parseFloat(data.replace(',', '').replace('TM', '').trim());
                    break;
                case 8:
                ...
                case 6:
                    ...
                    if(flightParts!==null && flightParts.length>0) {
                        ...
                        if(flightParts.length>1) {
                            flight_number = `${deal.flight}-${flightParts[1].trim()}`;
                        }
                    }
                    else {
                    ...
                    userinputs: [
                        {
                            id: 1,
                            controlid: '',
                            selector: 'div.pull-right > div.hidden-xs > a:nth-child(3)',
                            checkcontent: '',
                            type: 'button',
                            value: '',
                            action: 'click',
            ...
            actions: [
                {
                    ...
                    type: 'code',
                    repeat: true,
                    repeatsourceselector: '#ctl00_mainbody_pnlCity', //'#ctl00_mainbody_Panel1', /* Correct value : #ctl00_mainbody_Panel1*//*#ctl00_mainbody_Panel1 > div > .ChngColor > a > span*/
                    ...
                    userinputs: [
                        ...
                        // },                        
                        {
                            ...
                            controlid: '',
                            delaybefore: 100,
                            selector: `ctl00_mainbody_pnlCity > a:nth-of-type(n+{i})`,
                            isarray: false,
                            checkcontent: '',
                            type: '',
                            value: ``,
